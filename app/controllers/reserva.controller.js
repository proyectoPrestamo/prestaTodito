...
export const insertReserva = async (req, res) => {
   ...
   try {
      const result = await pool.query(`CALL spInsertReserva('${jornada}','${fecha_res}','${hora_res}','${tiempo_requerido}','${id_usuario}');`);
      res.json(result);
   } catch (error) {
...
export const updateReserva = async (req, res) => {
   ...
   try {
      const result = await pool.query(`CALL spUpdateReserva(${id},'${jornada}','${fecha_res}','${hora_res}','${tiempo_requerido}','${id_usuario}');`)
