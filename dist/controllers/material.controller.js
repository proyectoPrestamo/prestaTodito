...
var insertMaterial = /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(req, res) {
    var nombre, tipo, estado, cantidad, color, medida, id_horario, result;
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.prev = 7;
          _context3.next = 10;
          return _db.pool.query("CALL spInsertMaterial('".concat(nombre, "','").concat(tipo, "','").concat(estado, "','").concat(cantidad, "','").concat(color, "','").concat(medida, "',").concat(id_horario, ");"));
        case 10:
...
var updateMaterial = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(req, res) {
    var id, nombre, tipo, estado, cantidad, color, medida, id_horario, result;
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 8;
          _context5.next = 11;
          return _db.pool.query("CALL spUpdateMaterial(".concat(id, ",'").concat(nombre, "','").concat(tipo, "','").concat(estado, "','").concat(cantidad, "','").concat(color, "','").concat(medida, "','").concat(id_horario, "');"));
        case 11:
