...
var insertAmbientes = /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(req, res) {
    var id_ambiente, cantidad_sillas, cantidad_mesas, num_aprendices, num_equipos, result;
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.prev = 5;
          _context3.next = 8;
          return _db.pool.query("CALL spInsertAmbientes('".concat(id_ambiente, "','").concat(cantidad_sillas, "','").concat(cantidad_mesas, "','").concat(num_aprendices, "','").concat(num_equipos, "');"));
        case 8:
...
var updateAmbientes = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(req, res) {
    var id, cantidad_sillas, cantidad_mesas, num_aprendices, num_equipos, result;
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 5;
          _context5.next = 8;
          return _db.pool.query("CALL spUpdateAmbientes(".concat(id, ",'").concat(cantidad_sillas, "','").concat(cantidad_mesas, "','").concat(num_aprendices, "','").concat(num_equipos, "');"));
        case 8:
