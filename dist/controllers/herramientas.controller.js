    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _db.pool.query("CALL spFindAllHerramientas();");
        case 3:
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.prev = 1;
          _context2.next = 4;
          return _db.pool.query("CALL spFindHerramientas(".concat(id, ");"));
        case 4:
...
var insertHerramienta = /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(req, res) {
    var nombre, estado, tipo, cantidad, id_horario, result;
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.prev = 5;
          _context3.next = 8;
          return _db.pool.query("CALL spInsertHerramientas('".concat(nombre, "','").concat(estado, "','").concat(tipo, "','").concat(cantidad, "','").concat(id_horario, "');"));
        case 8:
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.prev = 1;
          _context4.next = 4;
          return _db.pool.query("CALL spDeleteHerramientas(".concat(id, ")"));
        case 4:
...
var updateHerramienta = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(req, res) {
    var id, nombre, estado, tipo, cantidad, id_horario, result;
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 6;
          _context5.next = 9;
          return _db.pool.query("CALL spUpdateHerramientas(".concat(id, ",'").concat(nombre, "','").concat(estado, "','").concat(tipo, "','").concat(cantidad, "','").concat(id_horario, "');"));
        case 9:
